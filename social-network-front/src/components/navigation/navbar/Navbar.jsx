...
class Navbar extends Component {
    ...
    selectResult=(e,{result})=>this.props.history.push(`/profile-view/${result._id}`)
    
    queryChange=(value)=>userApi.searchUser(value).then(resp=>this.setState({userOptions:resp}))
    ...
    onLogout=()=>this.props.logout().then(rsp=>this.props.history.push('/login'));
        ...
        return (
            <div className="custom-navbar">
                ...
                <div className="navbar-searchbar">
                        {
                            width >572 && <CustomSearch options={userOptions} queryChange={this.queryChange} selectResult={this.selectResult}/>
                        }
                </div>
                <div className="navbar-feature">
                        ...
                        <div className="feature-icon" onClick={()=>this.onClick('/discover-people')}>
                            <i aria-hidden="true" className="compass outline large icon"></i>
                        </div>
                        <div className="feature-user" onClick={()=>this.onClick('/profile')}>
