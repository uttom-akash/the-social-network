...
class ProfileForm extends Component {
    ...
    onSubmit=(event)=>{
        ...
        if(Object.keys(formError).length===0){
            ...
            this.props.updateProfile({name,newPassword,password})
                .then(resp=>this.setState({loading:false,status:"updated your info"}))
    ...
    onValidate=()=>{
        ...
        if(newPassword!==confirmPassword)error.confirmPassword="password didn't match"
        return error
    }
    
    render() {
        const {name,newPassword,confirmPassword,password,formError,status}=this.state
        return (
