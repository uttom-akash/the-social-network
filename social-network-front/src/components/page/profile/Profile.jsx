...
import {changeProfileImage,onFollow,onUnfollow} from '../../../redux/actions/AccountAction'
...
class Profile extends Component {
    ...
    componentWillMount=()=>{
        ...
        FeedApi.getMyPosts().then(resp=>this.setState({post:resp.posts}))
    }
    ...
    getViewList=()=>{
        ...
        if("My Post"===activeItem){
            ...
            return <UserListing user={followUsers} unfollow={this.onUnfollow} follow={this.onFollow}/>
        }
    ...
    render() {
        const {proPic,userName,name,email,changeImage,openedProPic,items,bottomMenu,activeItem}=this.state
        return (
            <div className="profile-container">
                <div className="profile-content">
                        <div className="profile-cover">
                            <div className="pro-pic" onMouseEnter={()=>this.setState({changeImage:true})} onMouseLeave={()=>this.setState({changeImage:false})}>
                                <img src={proPic}/>
                                {!openedProPic && changeImage && <label htmlFor="propic-upload" className="image-change">change image</label>}
                                {openedProPic && <div className="floating-confirm-discard">
                            ...
                            <div className="user">
                                ...
                                <Button text="Edit Profile" clsName="custom-btn" onClick={()=>this.props.history.push("/update-profile")}/>   
                            </div>
                        </div>
                ...
                <PureImageUpload onFileChange={this.onFileChange} clsName="propic-upload" />
            </div>
        )
    }
}
...
export default connect(mapStateToProps,{changeProfileImage,onFollow,onUnfollow})(Profile);